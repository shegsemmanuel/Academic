    ...
    <div className='bg-[#060E30] -mt-64' id='first-section'>
       <div className='mx-auto max-w-2xl pt-64 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8'>
        <div className='mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8'>
            ...
            <div className='col-span-4'>
                ...
                <div className='flex gap-4'>
                   <Link href='/'>
                    <img src={'/assets/footer/insta.svg'}
                     alt='instagram' className='footer-icons'/>
                   </Link>
                   <Link href='/'>
                   <img src={'/assets/footer/dribble.svg'}
                    alt='dribble' className='footer-icons'/>
                   </Link>
                   <Link href="/">
                   <img src={'/assets/footer/twitter.svg'}
                    alt='twitter'className='footer-icons'/>
                   </Link>
                   <Link href="/">
                   <img src={'/assets/footer/youtube.svg'}
                    alt='youtube' className='footer-icons'/>
                   </Link>
                </div>
            </div>
            ...
            {/* Column 2/3 */}
            {
                products.map((product) => (
                    ...
                    >
                        ...
                        <ul>
                            {product.link.map((link: string, index: 
                            number) => (
            ...
            <div className='col-span-4'>
                ...
                <div className='relative text-white focus-within:text-white flex flex-row-reverse'>
                    <input type='Email address' name='q'
                     ...
                     focus:outline-none bg-emailbg focus:text-white' placeholder='Your email address'
                     autoComplete='off'/>
        ...
        <div className='pb-24 px-4'>
              <h3 className='text-center text-white'>@2025 - All Rights Reserved. Education Website</h3>  
        </div>
